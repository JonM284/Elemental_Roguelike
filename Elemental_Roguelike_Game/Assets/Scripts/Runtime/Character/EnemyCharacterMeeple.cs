    ...
    public class EnemyCharacterMeeple: CharacterBase
    {
        ...
        public override async UniTask InitializeCharacter(CharacterStatsBase _characterStats)
        {
           /* side = ScriptableDataController.Instance.GetSideByGuid(characterSideRef);
            ...
            characterMovement.InitializeCharacterMovement(m_enemyMeepleStats.baseSpeed, m_enemyMeepleStats.movementDistance, m_enemyMeepleStats.damageScore, elementType, isGoalie);
