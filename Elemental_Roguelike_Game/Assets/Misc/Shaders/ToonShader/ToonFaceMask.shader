Shader "Custom/ToonFaceMask"
{
	Properties
	{
	    ...
	    _ReplaceColorR ("Color Override R value", Color) = (1,1,1,1)
	    _ReplaceColorG ("Color Override G value", Color) = (1,1,1,1)
	    _ReplaceColorB ("Color Override B value", Color) = (1,1,1,1)
	}
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col.rgb = col.rbg * (1 - cmask) + (_ReplaceColorR * mask.r) + (_ReplaceColorG * mask.g) + (_ReplaceColorB * mask.b);
				return col;
			}
			ENDCG
		}
